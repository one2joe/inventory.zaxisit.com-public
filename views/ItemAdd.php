...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fitemadd = new ew.Form("fitemadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fitemadd;
    ...
    // Form_CustomValidate
    fitemadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fitemadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fitemadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fitemadd" id="fitemadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
