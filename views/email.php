<?php namespace PHPMaker2022\inventory; ?>
<!-- email dialog -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ew-email-form" class="ew-form" action="<?= CurrentPageUrl(false) ?>" >
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label ew-label" for="sender"><?= $Language->phrase("EmailFormSender") ?></label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label ew-label" for="recipient"><?= $Language->phrase("EmailFormRecipient") ?></label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label ew-label" for="cc"><?= $Language->phrase("EmailFormCc") ?></label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label ew-label" for="bcc"><?= $Language->phrase("EmailFormBcc") ?></label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label ew-label" for="subject"><?= $Language->phrase("EmailFormSubject") ?></label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label ew-label" for="message"><?= $Language->phrase("EmailFormMessage") ?></label>
                        <div class="col-sm-9">
