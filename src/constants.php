...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "inventory"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{inventory}"); // Project ID
...
define(PROJECT_NAMESPACE . "FILE_SYSTEM_ENCODING", "UTF-8"); // File system encoding
