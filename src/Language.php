...
class Language
{
    ...
    public function languageLoad() {
        $this->setPhrase("enterrequiredfield", "");
        $this->setPhrase("Total", "");
        $this->setPhrase("Average", "");
        $this->setPhrase("Count", "");
        $this->setPhrase("Total", "");
        $this->setPhrase("Count", "");
        $this->setPhrase("Average", "");
        $this->setPhrase("aggregatecolon", "");
        $this->setPhrase("page", "");
        $this->setPhrase("of", "of");
        $this->setPhrase("record", "");
        $this->setPhrase("to", "-");
        $this->setPhrase("allrecords", "All");
    }
}
